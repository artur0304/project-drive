...
const selection = [
  ...
  { title: 'Race.Rally.Research (R3) 16-inch, 6-spoke alloy rim.jpg', slug: 'r3-16-six-spoke', brand: 'Race Rally Research', model: 'R3 6-spoke', style: '6_spoke', color: 'White', finish: 'Painted', sizeLabel: 'R16', diameter: 16 },
  { title: 'Race.Rally.Research (R3) 15-inch, twin 6-spoke alloy rim.jpg', slug: 'r3-15-twin-six', brand: 'Race Rally Research', model: 'R3 Twin 6-spoke', style: 'twin_6_spoke', color: 'White', finish: 'Painted', sizeLabel: 'R15', diameter: 15 },
  { title: 'Race.Rally.Research (R3) 17-inch, 7-spoke alloy rim.jpg', slug: 'r3-17-seven-spoke', brand: 'Race Rally Research', model: 'R3 7-spoke', style: '7_spoke', color: 'White', finish: 'Painted', sizeLabel: 'R17', diameter: 17 },
  { title: 'CalVintage.jpg', slug: 'calibre-vintage', brand: 'Calibre', model: 'Vintage', style: '5_spoke', color: 'Silver', finish: 'Polished lip' },
  { title: 'CalDub18.jpg', slug: 'calibre-dub-18', brand: 'Calibre', model: 'Dub', style: '5_spoke', color: 'Chrome', finish: 'Polished', sizeLabel: 'R18', diameter: 18 },
  { title: 'The tire wheels of Mercedes-AMG vehicles.JPG', slug: 'mercedes-amg-oem-display', brand: 'Mercedes-AMG', model: 'OEM display wheel', style: 'multi_spoke', color: 'Black / silver', finish: 'Machined' },
  { title: 'Rays F1 Rear Wheel.JPG', slug: 'rays-f1-rear', brand: 'RAYS', model: 'F1 Rear', style: 'motorsport', color: 'Gunmetal', finish: 'Satin' },
  { title: 'Madonna by Fast Wheels.jpg', slug: 'fast-wheels-madonna', brand: 'Fast Wheels', model: 'Madonna', style: 'multi_spoke', color: 'Silver', finish: 'Machined' },
  { title: 'DEZENTRBBP.jpg', slug: 'dezent-rb', brand: 'DEZENT', model: 'RB', style: '5_spoke', color: 'Black / silver', finish: 'Machined' },
  { title: 'Bbs cy500.jpg', slug: 'bbs-cy500', brand: 'BBS', model: 'CY500', style: '5_spoke', color: 'Silver', finish: 'Machined' },
  { title: 'Ferrari BBS Foto1.jpg', slug: 'bbs-ferrari-f1', brand: 'BBS', model: 'Ferrari F1 magnesium', style: 'motorsport', color: 'Magnesium', finish: 'Satin' },
  { title: 'Embedded World 2014 BBS-Rennfelge auf Porsche 997 GT3 Cup (04).jpg', slug: 'bbs-997-gt3-cup', brand: 'BBS', model: 'Porsche 997 GT3 Cup race', style: 'motorsport', color: 'Gold', finish: 'Satin' },
  { title: 'Porsche 911 GT3 R Hybrid wheel.jpg', slug: 'porsche-gt3-r-hybrid', brand: 'Porsche', model: '911 GT3 R Hybrid', style: 'motorsport', color: 'Black', finish: 'Satin' },
  { title: 'Jante RC Design.jpg', slug: 'rc-design-exhibit', brand: 'RC Design', model: 'Exhibit wheel', style: 'multi_spoke', color: 'Black / silver', finish: 'Machined' },
  { title: 'BBS, EMS 2023, Essen (P1160623-RR).jpg', slug: 'bbs-ems-2023-cutaway', brand: 'BBS', model: 'EMS 2023 cutaway', style: 'engineering_cutaway', color: 'Gold', finish: 'Machined' },
  { title: 'EMS 2023, Essen (P1160638).jpg', slug: 'bbs-ems-2023-01', brand: 'BBS', model: 'EMS 2023 exhibit 01', style: 'exhibit', color: 'Silver', finish: 'Machined' },
  { title: 'EMS 2023, Essen (P1160637).jpg', slug: 'bbs-ems-2023-02', brand: 'BBS', model: 'EMS 2023 exhibit 02', style: 'exhibit', color: 'Gold', finish: 'Satin' },
  { title: 'EMS 2023, Essen (P1160631).jpg', slug: 'bbs-ems-2023-03', brand: 'BBS', model: 'EMS 2023 exhibit 03', style: 'exhibit', color: 'Black', finish: 'Satin' },
  { title: 'EMS 2023, Essen (P1160624).jpg', slug: 'bbs-ems-2023-04', brand: 'BBS', model: 'EMS 2023 exhibit 04', style: 'exhibit', color: 'Silver', finish: 'Machined' },
  { title: 'EMS 2023, Essen (P1160622).jpg', slug: 'bbs-ems-2023-05', brand: 'BBS', model: 'EMS 2023 exhibit 05', style: 'exhibit', color: 'Black / gold', finish: 'Machined' },
];
...
// Migration 008 уже применена в существующих базах. Новые позиции пишем отдельно.
const migrationPath = path.resolve(here, '../migrations/015_expand_commons_wheel_catalog.sql');
